...
event-marketplace/ - MeetHive_Backend/ # Express + Prisma API - src/ - tests/ - .prettierrc - .gitignore - .env - docker-compose.yaml - Dockerfile - package-lock.json - package.json - eslint.config.mts - prisma.config.mts - tsconfig.json - README.md # Backend-specific setup - MeetHive_Frontend/ # React + Tailwind UI - src/ - public/ - .gitignore - package-lock.json - package.json - README.md # Frontend-specific setup - README.md # Root README

# Getting Started

1️. Clone the Repository

<pre> ``` git clone https://github.com/tabitht/Advanced_Event-Management-App.git``` </pre>
<pre> ``` cd Advanced_Event-Management-App``` </pre>

2️. Install Dependencies

Backend:

<pre> ``` cd MeetHive_Backend npm install``` </pre>

Frontend:

<pre> ``` cd ../MeetHive_Frontend npm install``` </pre>
...
<pre> ``` cd MeetHive_Backend npm run test``` </pre>

# Deployment

Backend → To be deployed on Render, Railway, or Heroku.
